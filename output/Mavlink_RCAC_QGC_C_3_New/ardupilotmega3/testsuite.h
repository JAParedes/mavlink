/** @file
 *    @brief MAVLink comm protocol testsuite generated from ardupilotmega3.xml
 *    @see http://qgroundcontrol.org/mavlink/
 */
#pragma once
#ifndef ARDUPILOTMEGA3_TESTSUITE_H
#define ARDUPILOTMEGA3_TESTSUITE_H
...
static void mavlink_test_common_GCS(uint8_t, uint8_t, mavlink_message_t *last_msg);
static void mavlink_test_ardupilotmega3(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    mavlink_test_common_GCS(system_id, component_id, last_msg);
    mavlink_test_ardupilotmega3(system_id, component_id, last_msg);
}
#endif

#include "../common_GCS/testsuite.h"
...
static void mavlink_test_ardupilotmega3(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
...
#endif // __cplusplus
#endif // ARDUPILOTMEGA3_TESTSUITE_H
