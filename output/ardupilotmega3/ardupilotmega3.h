/** @file
 *  @brief MAVLink comm protocol generated from ardupilotmega3.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_ARDUPILOTMEGA3_H
#define MAVLINK_ARDUPILOTMEGA3_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_ARDUPILOTMEGA3.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
...
#define MAVLINK_ENABLED_ARDUPILOTMEGA3
...
#endif // __cplusplus
#endif // MAVLINK_ARDUPILOTMEGA3_H
