/** @file
 *  @brief MAVLink comm protocol generated from common_GCS.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_COMMON_GCS_H
#define MAVLINK_COMMON_GCS_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_COMMON_GCS.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
...
#define MAVLINK_ENABLED_COMMON_GCS
