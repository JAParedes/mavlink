/** @file
 *  @brief MAVLink comm protocol generated from ardupilotmega2.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_ARDUPILOTMEGA2_H
#define MAVLINK_ARDUPILOTMEGA2_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_ARDUPILOTMEGA2.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
...
#endif // __cplusplus
#endif // MAVLINK_ARDUPILOTMEGA2_H
