/** @file
 *  @brief MAVLink comm protocol generated from rcac_qgc_2.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_RCAC_QGC_2_H
#define MAVLINK_RCAC_QGC_2_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_RCAC_QGC_2.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
